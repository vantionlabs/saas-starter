...
<p align="center">
  ...
  <img alt="348 unit tests" src="https://img.shields.io/badge/tests-348-2EAD33?style=flat-square" />
...
- ✅ **Tests that gate** — 348 unit, 41 browser, an eval set with a baseline, all in CI
...
`docs/admin.md` is the cross-tenant boundary and what enforces it, and
