...
<p align="center">
  ...
  <img alt="365 unit tests" src="https://img.shields.io/badge/tests-365-2EAD33?style=flat-square" />
...
- ✅ **Tests that gate** — 365 unit, 41 browser, an eval set with a baseline, all in CI
...
| -------- | ---------------------------- | -------------------------------------------------------------------------------------------------------------- |
| **Next** | Two-factor on staff accounts | The admin panel is only as strong as an individual's account, and nothing enforces a second factor on one yet. |
