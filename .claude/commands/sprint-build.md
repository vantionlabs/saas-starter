---
description: Days 13-24. Build the feature list in vertical slices, each one green before the next.
argument-hint: "[the feature]"
---

Run the build phase of the 30-day sprint for: **$ARGUMENTS**

Read `docs/sprint/03-build.md` and follow it, and read `RULES.md` before writing
anything.
...
Update `docs/sprint/STATE.md` after each slice lands.
