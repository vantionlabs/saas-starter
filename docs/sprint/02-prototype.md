...
This is the single rule that keeps day 12 reachable. A screen that needs a schema
...
- Screenshots in `docs/sprint/prototype/`, so the build phase can see the target
